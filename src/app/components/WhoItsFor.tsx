...
export const WhoItsFor = () => {
  ...
  return (
    <section id="who-its-for" className="py-24 px-6 md:px-12 bg-background overflow-hidden relative">
      <div className="max-w-7xl mx-auto relative">
        <div className="text-center mb-16">
          ...
          <motion.p 
            ...
            className="text-xl text-[#003636]/70 max-w-2xl mx-auto font-body"
          >
          ...
          <div className="lg:col-span-8 relative">
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="bg-white rounded-2xl border border-[#CCCCCC]/40 shadow-[0_20px_50px_rgba(0,54,54,0.04)] overflow-hidden min-h-[580px] flex flex-col relative"
              >
                <div className="p-8 lg:p-12 flex-grow relative">
                  {/* Block 1: Role Summary */}
                  <div className="mb-10 relative">
                    <p className="text-2xl lg:text-3xl text-[#003636] font-title leading-tight max-w-2xl">
                      {activeRole.summary}
                    </p>
                  </div>
                  ...
                  <div className="mb-10 relative">
                    <span className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#006D69] mb-4 font-body">
                      Example question
                    </span>
                    <blockquote className="text-xl lg:text-2xl font-display italic text-[#003636]/80 border-l-3 border-[#006D69]/20 pl-8 py-2">
                      “{activeRole.question}”
                    </blockquote>
                  </div>
                  ...
                  <div className="mb-8 relative">
                    <span className="block text-[10px] font-bold uppercase tracking-[0.2em] text-[#006D69] mb-5 font-body">
                      Typical output
                    </span>
                    <div className="bg-[#FEFDFB]/50 border border-[#CCCCCC]/20 rounded-2xl p-8 font-body relative group/output">
                      <div className="absolute top-0 right-0 p-3 opacity-20 group-hover/output:opacity-40 transition-opacity">
                        <div className="w-2 h-2 rounded-full bg-[#006D69]" />
                      </div>
                      
                      {activeRole.id === 'devs' ? (
                        <div className="space-y-6 relative">
                          <div className="bg-[#003636] rounded-xl p-5 overflow-hidden shadow-lg shadow-black/20">
                            <pre className="text-xs lg:text-sm text-[#006D69] leading-relaxed overflow-x-auto custom-scrollbar">
                        ...
                        <ul className="space-y-4 relative">
                          {activeRole.output?.map((item, i) => (
                            <li key={i} className="flex items-start gap-4 text-[#003636]/80 group/item">
                              <span className="w-1.5 h-1.5 rounded-full bg-[#006D69]/40 group-hover/item:bg-[#006D69] mt-2.5 shrink-0 transition-colors" />
                              <span className="leading-relaxed text-base lg:text-lg">{item}</span>
                            </li>
                          ))}
                        </ul>
                      )}
                ...
                <div className="bg-[#F8F9F9] border-t border-[#CCCCCC]/20 p-5 px-8 lg:px-12 relative">
                  <p className="text-[11px] text-[#003636]/50 font-body tracking-wide">
